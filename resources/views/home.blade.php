...
<head>
    ...
    <link href="{{ asset('homePage/lib/flaticon/font/flaticon.css') }}" rel="stylesheet">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-12">
                    <div class="logo">
                        <a href="index.html">
                            <h1>velvet<span>vehicle</span></h1>
                ...
                @foreach ($products as $product)
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <a class="btn btn-custom" href="">المزيد</a>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <div class="about">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="{{asset('homePage/img/about.jpg')}}" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="about-content">
                        <p>
                            المركبة المخملية هي مغسلة سيارات متنقلة رائدة في جدة، المملكة العربية السعودية، تقدم خدمات
                            غسيل السيارات بأعلى معايير الجودة والاحترافية. نسعى لتقديم تجربة فريدة ومريحة لعملائنا من
                            خلال توفير خدماتنا في أي وقت وأي مكان. سواء كنت في المنزل، العمل، أو في أي مكان آخر، نحن
                            نأتي إليك لتوفير العناية الفائقة لسيارتك.

                            نتخصص في تقديم غسيل شامل وتنظيف داخلي وخارجي باستخدام أحدث الأدوات والمواد الصديقة للبيئة،
                            مما يضمن لسيارتك مظهراً لامعاً ونظافة تدوم. نهدف إلى إرضاء عملائنا من خلال الالتزام
                            بالمواعيد وتقديم خدمة سريعة وفعّالة.

                            اختيارك للمركبة المخملية يعني اختيار الراحة والتميز والعناية الفائقة بسيارتك، مع فريقنا
                            المدرب بعناية والذي يضمن لك أفضل النتائج في كل مرة.

                            لن تحتاج بعد اليوم إلى الانتظار طويلاً في محطات الغسيل، فنحن نأتي إليك لنجعل سيارتك تلمع
                            بأفضل حالاتها.
                        </p>
                        <ul>
